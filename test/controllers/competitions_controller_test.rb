...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competition" do
    assert_difference("Competition.count") do
      post competitions_url, params: { competition: { age_from: @competition.age_from, age_to: @competition.age_to, description: @competition.description, name: @competition.name, topic: @competition.topic } }
    end
  ...
  test "should update competition" do
    patch competition_url(@competition), params: { competition: { age_from: @competition.age_from, age_to: @competition.age_to, description: @competition.description, name: @competition.name, topic: @competition.topic } }
